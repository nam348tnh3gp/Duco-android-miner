...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _startMining() async {
    ...
    try {
      ...
      // Android can keep the miner alive with a foreground service.
      // iOS intentionally stays in-app; iOS does not provide an equivalent
      // unrestricted background CPU service for continuous mining.
